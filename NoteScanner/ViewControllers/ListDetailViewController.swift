...
class ListDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        viewMode = listObject == nil ? .addMode : .editMode
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        case .editMode:
            self.saveData()
            self.delegate?.dataDidSave(listObject: listObject)
        }
    }
    ...
    func loadDataInView() {
        ...
        case .addMode:
            ...
            self.title = "New List"
        case .editMode:
            titleData = listObject.title
            dateData = listObject.editedTime
            textData = listObject.text
    ...
    func saveData() {
        ...
        case .addMode:
            ...
            listObject = Note(id: UUID().uuidString, userId: identityID , title: titleData, text: textData, editedTime: dateData, type: "\(TextType.list)")
        case .editMode:
            listObject.title = titleData
            listObject.editedTime = dateData
            listObject.text = textData
        }
    }
    ...
    @IBAction func pressRightNavButton(_ sender: Any) {
        ...
        case .addMode: //Save Record
            saveData()
            delegate?.newListCreated(listObject: listObject)
